...
// --- Read/Write files ---
void readExpData(std::string file, std::vector<double> &Texp, std::vector<double> &PsatExp, std::vector<double> &vGexp, std::vector<double> &vLexp, std::vector<double> &hGexp, std::vector<double> &hLexp, std::vector<double> &LvExp, std::vector<double> &eLexp, std::vector<double> &eGexp, std::vector<double> &sLexp, std::vector<double> &sGexp);
